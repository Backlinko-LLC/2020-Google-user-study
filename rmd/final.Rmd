...
```{r}
include_png("engines")
include_png("engines2")
include_png("how_do_you_use_gs")
```
...
```{r}
include_png("When typing the search query, did they select one of the suggested searches? (Y/N)")
```
...
include_png("Seconds to first click (use check time stamping on video)_facets")
...
include_png("Seconds to complete search task_facets")
...
include_png("Total Clicks_facets")
