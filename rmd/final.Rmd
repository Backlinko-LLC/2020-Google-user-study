---
title: "Google User Behaviour Research Study"
...
* Step 1 **Survey Questions**: Firstly, we aimed at providing a balanced of on the type of research questions. 
...
Survey questions: https://docs.google.com/document/d/1HNIJ_mWbREtgWrVgm5EvbhTjxL8he_Ix-HnHVBuuKHQ/edit?usp=sharing 

* Step 2

an example video can be watched here
...
the number of seconds to complete a search show collerations from 0.7 to 0.9.

This may indicate that users faced with a challenging Google search try different strategies.

```{r}
include_png("correlations")
```
