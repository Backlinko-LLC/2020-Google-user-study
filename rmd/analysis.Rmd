...
plots[[item]] <- bar_chart(
  full_data, item,
  "On average, 83% of users never bounce", "Number of clicks followed by bounces",  "% of users", 2)
...
plots[[item]] <- quantile_chart(
  full_data, item,
  "On average a user takes 1 min 16 seconds\nto complete a search",
